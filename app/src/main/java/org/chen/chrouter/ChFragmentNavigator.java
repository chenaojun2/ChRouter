 ...
 */
@Navigator.Name("chfragment")
public class ChFragmentNavigator extends Navigator<ChFragmentNavigator.Destination> {
    ...
    public ChFragmentNavigator(@NonNull Context context, @NonNull FragmentManager manager,
                               int containerId) {
        mContext = context;
    ...
    /**
     * NavDestination specific to {@link ChFragmentNavigator}
     */
    ...
    public static class Destination extends NavDestination {
        ...
        public Destination(@NonNull NavigatorProvider navigatorProvider) {
            this(navigatorProvider.getNavigator(ChFragmentNavigator.class));
        }
         ...
         * Fragment via {@link #setClassName(String)}.
         *
         * @param fragmentNavigator The {@link ChFragmentNavigator} which this destination
