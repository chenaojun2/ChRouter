...
import org.chen.chrouter.model.BottomBar;
import org.chen.chrouter.model.Destination;
...
public class NavUtil {
    ...
    public static void buildNavGraph(FragmentActivity activity, FragmentManager childFragmentManager, NavController controller, int containerId) {
        ...
        ChFragmentNavigator chFragmentNavigator = new ChFragmentNavigator(activity, childFragmentManager, containerId);
        provider.addNavigator(chFragmentNavigator);
        ...
        while (iterator.hasNext()) {
            ...
            if (destination.destType.equals("activity")) {
                ...
                ChFragmentNavigator.Destination node = chFragmentNavigator.createDestination();
                node.setId(destination.id);
